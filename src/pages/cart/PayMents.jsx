              ...
              <form action="">
                <div className="grid grid-cols-12 mb-4">
                  <div className="col-span-6">
                    ...
                    <input
                      className="w-full border py-1 mt-2 focus:border-lime-400 outline-none hover:shadow-inner foucs:shadow-lime-400"
                      type="text"
                      name=""
                      id=""
                    />
                ...
                <div className="form-group">
                  ...
                  <br />
                  <select name="" id="" className="border w-full py-1.5 mt-2">
